...
const jsonLeidoLista = JSON.parse(fs.readFileSync("./bicicletas.json","utf-8")) //bicicletas es el nombre dle arhivo que quiero leer
...
const mayores = edades.filter(elemento => elemento > 18) // filtra los elementos del array mayores a 18
...
const paises = ['Argentina', 'Cuba', 'Perú'];
